...
########################
# prepare Eco.IDL1.Java
include $(CLEAR_VARS)
LOCAL_MODULE    := libC26F52E0372D4051A290C1BD286DCE90
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/libC26F52E0372D4051A290C1BD286DCE90.a 
include $(PREBUILT_STATIC_LIBRARY)
########################
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoIDL1Java.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoIDL1JavaUnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 C26F52E0372D4051A290C1BD286DCE90
