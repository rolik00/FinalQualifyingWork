...
########################
# prepare Eco.IDL1.CPP
include $(CLEAR_VARS)
LOCAL_MODULE    := lib8F45C7FFB8144066BEAFF11296176293
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/lib8F45C7FFB8144066BEAFF11296176293.a 
include $(PREBUILT_STATIC_LIBRARY)
########################
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoIDL1CPP.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoIDL1CPPUnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 8F45C7FFB8144066BEAFF11296176293
