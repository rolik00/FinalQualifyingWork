...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/lib54F2EF99574346E49122AA7840BB8A88.a 
include $(PREBUILT_STATIC_LIBRARY)
########################
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoIDL1.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoIDL1UnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 54F2EF99574346E49122AA7840BB8A88
