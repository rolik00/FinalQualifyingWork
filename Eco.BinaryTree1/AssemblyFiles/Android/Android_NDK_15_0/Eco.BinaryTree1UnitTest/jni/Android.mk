...
########################
# prepare Eco.BinaryTree1
include $(CLEAR_VARS)
LOCAL_MODULE    := lib7CAD4D0215EF4EDFB1FF6A7CAF1C3D6C
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/lib7CAD4D0215EF4EDFB1FF6A7CAF1C3D6C.a 
include $(PREBUILT_STATIC_LIBRARY)
########################

#
# EcoBinaryTree1UnitTest
#
include $(CLEAR_VARS)
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoBinaryTree1.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoBinaryTree1UnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 7CAD4D0215EF4EDFB1FF6A7CAF1C3D6C
