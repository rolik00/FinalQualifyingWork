...
# prepare Eco.BSA1
include $(CLEAR_VARS)
LOCAL_MODULE    := libFF73C4B2F8B0484897DB3298F6E9D8E1
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/libFF73C4B2F8B0484897DB3298F6E9D8E1.a 
include $(PREBUILT_STATIC_LIBRARY)
########################
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoBSA1.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoBSA1UnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 FF73C4B2F8B0484897DB3298F6E9D8E1
