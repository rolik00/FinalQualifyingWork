...
########################
# prepare Eco.IDL1.Python
include $(CLEAR_VARS)
LOCAL_MODULE    := lib4F8058F313B346A887D59E582C7799FC
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/lib4F8058F313B346A887D59E582C7799FC.a 
include $(PREBUILT_STATIC_LIBRARY)
########################

#
# EcoIDL1PythonUnitTest
#
include $(CLEAR_VARS)
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoIDL1Python.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoIDL1PythonUnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 4F8058F313B346A887D59E582C7799FC
